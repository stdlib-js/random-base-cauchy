...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-base-cauchy/tags). For example,

```javascript
cauchy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-cauchy@v0.2.0-umd/browser.js' )
```
